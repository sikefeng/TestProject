...
import com.example.sikefeng.testproject.d.swiperefresh.loadmore.New;
...
public class ItemsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ItemsAdapter(Context context, List<New> data,RecyclerView recyclerView) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if(viewType==EMPTY_VIEW){
            ...
            return new ProgressViewHolder(mLayoutInflater.inflate(R.layout.item_foot, parent, false));
        }else{
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof ItemHolder) {
            final String string = mData.get(position).getTitle();
